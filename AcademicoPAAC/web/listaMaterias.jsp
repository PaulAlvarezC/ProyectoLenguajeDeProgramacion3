                ...
                <center>
                    <div class="col-sm-6">
                        <div class="card">
                            ...
                            <form action="Controlador?accion=ListaMateriasPorCurso" method="post">
                                <div class="card-body">
        ...
        <div class="container mt-2">
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <c:forEach var="p" items="${materiasPorCurso}">
                            <tr>
                                <td>${p.getDescripcion()}</td>
                                <td>${p.getCurso()}</td>
                                <td>
                                    <a href="Controlador?accion=EditarMateria&id=${p.getId()}" class="btn btn-outline-info"><i class="fas fa-edit"></i></a>
                                    <a href="Controlador?accion=EliminarMateria&id=${p.getId()}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
